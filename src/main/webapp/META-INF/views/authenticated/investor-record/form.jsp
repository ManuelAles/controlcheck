...
<acme:form readonly="true">
	...
	<acme:form-textbox code="authenticated.investor-record.form.label.investingStatment" path="investingStatment" />
	<acme:form-textbox code="authenticated.investor-record.form.label.stars" path="stars"/>
	
	<acme:form-return code="authenticated.investor-record.button.return" />
