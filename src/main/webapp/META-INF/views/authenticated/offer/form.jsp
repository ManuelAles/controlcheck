...
<acme:form readonly="true">
	...
	<acme:form-textbox code="authenticated.offer.form.label.text" path="text" />	
	<acme:form-textbox code="authenticated.offer.form.label.ticker" path="ticker" />	
	<acme:form-reward code="authenticated.offer.form.label.reward" path1="minMoney" path2="maxMoney" />	
	
	<acme:form-return code="authenticated.offer.button.return" />
