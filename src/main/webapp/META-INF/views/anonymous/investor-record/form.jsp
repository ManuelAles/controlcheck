...
<acme:form readonly="true">
	...
	<acme:form-textbox code="anonymous.investor-record.form.label.investingStatment" path="investingStatment" />
	<acme:form-textbox code="anonymous.investor-record.form.label.stars" path="stars"/>
	
	<acme:form-return code="anonymous.investor-record.button.return" />
